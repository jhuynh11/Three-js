...
// field variables
var fieldWidth = 600, fieldHeight = 200;
...
function createScene()
{
	...
	var texture = new THREE.TextureLoader().load("http://localhost/Programming/Pictures/Garfield.png");
...
function matchScoreCheck()
{
	...
	else if (score2 >= maxScore)
	{
		...
		ballSpeed = 0;
		// write to the banner
		document.getElementById("scores").innerHTML = "Get pwned noob!";
		document.getElementById("winnerBoard").innerHTML = "Refresh to play again";
		// make paddle bounce up and down
		bounceTime++;
